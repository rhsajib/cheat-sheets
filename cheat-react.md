...
import { handleTextToPdfUpload } from "../../services/api/handlers";
...
const TextToPdf = () => {
    ...
    const handleUploadButtonClick = () => {
        ...
        handleTextToPdfUpload(formData);
    };

    return (
        <div className="">
            <div className="flex">
                <label htmlFor="fileInput">Upload Text File (max size: 20 MB): </label>
                <input
                    className="px-4"
                    type="file"
                    id="fileInput"
...
```js
//services/api/handlers.js

import axios from "axios";
import { textToPdfApiUrl } from "./apiEndPoints";

const handleTextToPdfUpload = (formData) => {
    console.log(formData);
    axios
        .post(textToPdfApiUrl, formData)
        .then((response) => {
